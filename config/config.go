...
import (
	...
	"github.com/jerrywange2025/newke_server_lib/pkg/util"
...
const (
	...
	SMSProviderClickSend SMSProvider = "clicksend"
)
...
type OSSConfig struct {
	Endpoint        string
	BucketName      string // Bucket名称 比如 chatiapp
